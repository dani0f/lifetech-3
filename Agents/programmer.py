...
def askProgrammer(ask):
    ...
    Idea: utiliza tamaños y fuentes según la jerarquía del contenido de la presentacion, para descatar subtitulos usa el color #00a19a y utiliza siempre blanco para el fondo. Por último, incluye iconos de fontawesome que vayan acorde con el contenido de la diapositiva."""
    
    example_ai = """<div class="slide" style="display: flex; height: 100vh; align-items: stretch; justify-content: center; overflow-x: auto;"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"><div class="column white" style="flex: 1; padding: 2rem; color: #000; background-color: #fff; display: flex; align-items: center; justify-content: center;"><div class="content" style="text-align: center;"><h1 style="color: #00a19a;">FICHA TÉCNICA</h1><h2>PROTOCOLO DE VIGILANCIA TRASTORNOS MUSCULOESQUELÉTICOS RELACIONADOS AL TRABAJO (TMERT)</h2><div style="display: flex; justify-content: center;"></div></div></div></div>|
<div class="slide" style="display: flex; height: 100vh; align-items: stretch; justify-content: center; overflow-x: auto;"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"><div class="column white" style="flex: 1; padding: 2rem; color: #000; background-color: #fff; display: flex; align-items: center; justify-content: center;"><div class="content" style="font-family: 'Arial', sans-serif;"><h1 style="color: #00a19a; font-family: 'Helvetica Neue', Arial, sans-serif;">¿Qué es el Protocolo TMERT?</h1><h2 style="font-family: 'Helvetica Neue', Arial, sans-serif;">Procedimiento y objetivos</h2><i class="fa-solid fa-bullseye" style="font-size: 3em;"></i><p style="font-size: 1.2em; font-family: 'Arial', sans-serif;">Es un procedimiento que entrega directrices para la prevención y control de los trastornos musculoesqueléticos (TME) de las extremidades superiores en las empresas. Contempla la identificación y evaluaciones de factores de riesgo biomecánicos, organizacionales y psicosociales en los puestos de trabajo, además de la vigilancia a la salud de los trabajadores expuestos.</p></div></div></div>|
<div class="slide" style="display: flex; height: 100vh; align-items: stretch; justify-content: center; overflow-x: auto; background-color: #fff;"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"><div class="column white" style="flex: 1; padding: 2rem; color: #000; background-color: #fff; display: flex; align-items: center;"><div class="content" style=""><i class="fa-regular fa-file" style="font-size: 3em; margin-left: 1em; margin-right: 1em;"></i><h1>Normativa asociada</h1><h2>Responsabilidades de la empresa</h2><ul style="list-style-type: disc; text-align: left;"><li style="font-size: 1.2em;">Evaluar los factores de riesgos detectados y aplicar un programa de control del riesgo.</li><li style="font-size: 1.2em;">Eliminar o mitigar los riesgos detectados y aplicar un programa de control del riesgo.</li><li style="font-size: 1.2em;">Informar a los trabajadores sobre los factores a los que están expuestos, las medidas preventivas y los métodos de trabajo correctos.</li><li style="font-size: 1.2em;">Cumplir con la Norma Técnica MINSAL TMERT de extremidades superiores y el Protocolo de Vigilancia para trabajadores expuestos a factores de riesgo de TMERT.</li></ul></div></div></div>|
...
<div class="slide" style="display: flex; height: 100vh; align-items: center; justify-content: center; background-color: #fff;"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"><div class="column white" style="padding: 2rem; color: #000; display: flex; align-items: center; justify-content: center;"><div class="content"><h1 h1 style="color: #00a19a;">¡Gracias por su atención!</h1><h2>Fuentes:</h2><ol><li style="font-size: 1.2em;"><strong>Nombre del archivo:</strong> protocolos-ministerio-de-salud-trastornos-musculoesqueléticos-relacionados-al-trabajo-tmert.pdf</li></ol></div></div></div>|"""
