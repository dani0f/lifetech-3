...
def askProgrammer(ask):
    ...
    Idea: Utiliza siempre fondo blanco #fff, estilo de letra font-family: 'Arial', sans-serif;" y incluye iconos de fontawesome de tipo "solid" que vayan acorde con el contenido de la diapositiva."""
